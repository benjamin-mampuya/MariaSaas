...
export const StatCard: React.FC<Props> = ({ title, value, change, color, icon }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 p-7  border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-xl hover:shadow-emerald-500/5 transition-all duration-300 group">
